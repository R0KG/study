...
public class MainClient {
	public static void main(String[] args) {
		...
		if (args.length < 3) {
			System.err.println("Usage: java MainClient <serverBaseUrl> <gameId> <playerId>");
			return;
		}

		String serverBaseUrl = args[0];
		String gameId = args[1];
		String playerId = args[2];

		GameLogic gameLogic = new GameLogic(serverBaseUrl,gameId,playerId);
		gameLogic.start();
	}
}
